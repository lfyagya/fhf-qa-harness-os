...
Rule text lives in \`rules/\`. \`.claude/rules/\` symlinks to those files. \`.cursor/rules/*.mdc\` is a generated wrapper with the same body.

${ruleIndexText()}

Do not preload every rule body. Load the full file when its path matches the work.
