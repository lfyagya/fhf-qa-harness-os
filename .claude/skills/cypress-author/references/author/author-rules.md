...
This file is only reached for non-FHF projects — `subskills/task.md` stops the skill before
this point for either FHF Cypress repo. See `.claude/rules/agent-spawning-gate.md` for why.
