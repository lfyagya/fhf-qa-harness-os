...
class <ModuleName>SchemaConstants(BaseSchema):
    ...
    # Tables — FIRSTHELP_COLL
    # table_<name>: str = <Module>Tables.<NAME>
    
    # Views — FIRSTHELP_COLL
...
- **Reference:** See tests/repo_invoice/conftest.py, tests/ancillary/ancillary_cancellation_dashboard/conftest.py
