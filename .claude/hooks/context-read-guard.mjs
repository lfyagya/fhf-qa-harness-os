...
const isBounded = Number.isInteger(limit) && limit > 0 && limit <= policy.maxLines;
const isSmall = filePath && existsSync(filePath) && statSync(filePath).size <= policy.unboundedReadMaxBytes;
