...
## 5. Add Data Factory under `tests/commons/data_builder/`
- Add `tests/commons/data_builder/<module>.py`; shared payload code goes in `shared.py`
...
# The full suite (pytest tests/ --order-scope=module -v) is the owner's run, not the agent's
```
